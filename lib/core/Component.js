...
var Component = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Component() {
    ...
    _this = _super.call(this); //TODO: reimplement any flags for debug data
    //this._flags = {};
    //this._flags.DEBUG = options.debug || false;

    _this.needsDraw = true;
    _this.needsRender = true;
    _this.d = new _vectorious.Vector([options.x || 0, options.y || 0]);
    /**
    ...
    _this.style = Object.assign({}, defaults, options.style);
    /**
    ...
    value: function draw(context, offset) {
      ...
      if (this.needsRender) {
        ...
        */
        ...
        this.prerenderingCanvas.height = boundingBox.bottom - boundingBox.top; //clear any old rendering artifacts - they are no longer viable

        (0, _Renderer.clearRect)(0, 0, this.prerenderingCanvas.width, this.prerenderingCanvas.height, this.prerenderingContext);
        this.render();
      ...
      (0, _Renderer.drawImage)(x, y, this.prerenderingCanvas, context, this.style);
    }
    /**
