 ...
 */
function clearRect(x, y, width, height, context) {
...
function drawPath(vertices, context, style) {
...
function drawPolygon(vertices, context, style) {
  Object.assign(context, style);
  context.beginPath();
  context.moveTo(vertices[0].x, vertices[0].y);
...
function drawBezier(start, end, c1, c2, context, style) {
...
function drawRectangle(x, y, width, height, context, style) {
  Object.assign(context, style);
...
function drawEllipse(x, y, radius, minorRadius, context, style) {
...
function drawCircle(x, y, radius, context, style) {
  Object.assign(context, style);
...
function drawText(x, y, text, context, style) {
  Object.assign(context, style);
...
function drawImage(x, y, image, context, style) {
