 ...
 */
var VectorPath = /*#__PURE__*/function (_Component) {
  _inherits(VectorPath, _Component);
  ...
  _createClass(VectorPath, [{
    ...
    value: function render() {
      ...
      var offset = this.offset; //let compoundScale = this.compoundScale;
      ...
      (0, _Renderer.drawPath)(pathToDraw, this.prerenderingContext, this.style);
    }
  }]);

  return VectorPath;
}(_Component2["default"]); //for scaling a vector
//TODO: reimplement scaling
