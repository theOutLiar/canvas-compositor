...
var Circle = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Circle, [{
    ...
    value: function render() {
      ...
      (0, _Renderer.drawCircle)(this.radius * scale.scaleWidth + lineWidth, this.radius * scale.scaleHeight + lineWidth, this.radius * scale.scaleWidth, this.prerenderingContext, this.style);
    }
    /**
