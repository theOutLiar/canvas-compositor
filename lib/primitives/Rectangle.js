...
var Rectangle = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Rectangle, [{
    ...
    value: function render() {
      var compoundScale = this.compoundScale;
      (0, _Renderer.drawRectangle)(this.style.lineWidth, this.style.lineWidth, this.width * compoundScale.scaleWidth, this.height * compoundScale.scaleHeight, this.prerenderingContext, this.style);
    }
  }]);
